...
namespace Advertise.Web.Views.Role
{
    ...
    public partial class List : Advertise.Web.Framework.ViewEngines.Razor.WebViewPage<Advertise.Core.Models.Role.RoleListViewModel>
    {
        public List()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\Role\List.cshtml"
  
    Layout = MVC.Shared.Views.SiteLayout.Panel._PanelLayout;
    ViewBag.Title = Admin.ListRole;
...
WriteAttribute("class", Tuple.Create(" class=\"", 329), Tuple.Create("\"", 432)
, Tuple.Create(Tuple.Create("", 337), Tuple.Create<System.Object, System.Int32>(new System.Web.WebPages.HelperResult(__razor_attribute_value_writer => {
...
WriteLiteral("        ");
            ...
            #line 13 "..\..\Views\Role\List.cshtml"
...
WriteLiteral("        ");
            ...
            #line 14 "..\..\Views\Role\List.cshtml"
...
WriteLiteral(">\r\n        <h1>");
            ...
            #line 19 "..\..\Views\Role\List.cshtml"
             if (Model.IsMine != true){
            
            #line default
            #line hidden
WriteLiteral("لیست نقش ها");
...
WriteLiteral(">\r\n");
            ...
            #line 25 "..\..\Views\Role\List.cshtml"
            ...
            #line 25 "..\..\Views\Role\List.cshtml"
                 if (User.IsInRole(PermissionConst.CanRoleCreate))
                {
            ...
            #line 27 "..\..\Views\Role\List.cshtml"
               Write(Html.Partial(MVC.Role.Views._AddItem));
...
WriteLiteral("                ");
           ...
           Write(Html.Partial(MVC.Role.Views._ListMore, Model.Roles));
...
WriteLiteral("        ");
            ...
            #line 35 "..\..\Views\Role\List.cshtml"
