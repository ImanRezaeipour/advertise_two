...
namespace Advertise.Web.Controllers
{
    ...
    public partial class ProfileController : BaseController
    {
        ...
        public virtual ActionResult Header()
        {
            ...
            return PartialView(MVC.Shared.Views.SiteLayout.Profile._ProfileHeader, viewModel);
        }
        ...
        public virtual ActionResult Menu()
        {
            ...
            return PartialView(MVC.Shared.Views.SiteLayout.Profile._ProfileMenu, viewModel);
        }
