...
namespace Advertise.Web.Controllers
{
    ...
    public partial class AccountController : BaseController
    {
        ...
        [MvcAuthorize(PermissionConst.CanUserEasyRegister)]
        [ImportModelData(typeof(UserOperatorCreateViewModel))]
        public virtual async Task<ActionResult> EasyRegister()
        {
            var viewModel = await _accountFactory.PrepareUserOperatorCreateViewModel();
            return View(MVC.Account.Views.EasyRegister, viewModel);
        }
        ...
        [MvcAuthorize(PermissionConst.CanAccountSetPassword)]
        [MvcSiteMapNode(ParentKey = "Profile_Home_Index", Title = "تنظیم پسورد", Key = "Profile_User_SetPassword")]
        public virtual ActionResult SetPassword()
        {
            return View(MVC.User.Views.SetPassword);
        }
        ...
        [ValidateInput(false)]
        [MvcAuthorize(PermissionConst.CanAccountSetPassword)]
        public virtual async Task<ActionResult> SetPassword(UserSetPasswordViewModel viewModel)
        {
            if (viewModel == null)
                return View(MVC.Error.Views.BadRequest);
            ...
            return RedirectToAction(MVC.Account.SetPassword());
        }
