...
namespace Advertise.Web.Framework.Results
{
    /// <summary>
        ...
        private bool TryApplyContentType(string acceptType, ControllerContext context)
        {
            ...
            if (!string.IsNullOrEmpty(ViewName) && acceptType == "text/html")
            {
                ...
                var viewResult = new ViewResult
                {
                    ...
                    ViewEngineCollection = ((System.Web.Mvc.Controller)context.Controller).ViewEngineCollection
                };
    ...
    public static class NegotiatedResultExtensions
    {
        ...
        /// }
        /// </example>
        public static NegotiatedResult Negotiated(this System.Web.Mvc.Controller controller, object data)
        {
        ...
        /// }
        /// </example>
        public static NegotiatedResult Negotiated(this System.Web.Mvc.Controller controller, string viewName, object data)
        {
