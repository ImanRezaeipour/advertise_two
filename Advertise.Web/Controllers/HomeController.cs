...
namespace Advertise.Web.Controllers
{
    ...
    public partial class HomeController : BaseController
    {
        ...
        public virtual ActionResult MainMenu()
        {
            ...
            return PartialView(MVC.Shared.Views._MainMenu, viewModel);
        }
        ...
        {
            var viewModel = AsyncContext.Run(_categoryFactory.PrepareMainMenuViewModelAsync);
            return PartialView(MVC.Shared.Views._SideMenuLeft, viewModel);
        }
        ...
        public virtual ActionResult SideMenuHeader()
        {
            ...
            return PartialView(MVC.Shared.Views._SideMenuHeader, viewModel);
        }
        ...
        public virtual ActionResult SideMenuRight()
        {
            ...
            return PartialView(MVC.Shared.Views._SideMenuRight, viewModel);
        }
