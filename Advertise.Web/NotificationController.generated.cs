...
namespace Advertise.Web.Controllers
{
    public partial class NotificationController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Item = "~/Views/Notification/_Item.cshtml";
            public readonly string _ListMore = "~/Views/Notification/_ListMore.cshtml";
            public readonly string List = "~/Views/Notification/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_NotificationController : Advertise.Web.Controllers.NotificationController
    {
        ...
        [NonAction]
        partial void MyListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.Notification.NotificationSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> MyList(Advertise.Core.Models.Notification.NotificationSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.MyList);
