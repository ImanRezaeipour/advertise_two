...
//function onKendoLoadNavigator() {
    
//    $("[data-tree-product]").each(function() {
//        var e = $(this).data('tree-event');
//        if(e === "load")
//            fillKendoTreeProduct(this);
//    });

//    $("[data-file]").each(function() {
//        var e = $(this).data('file-event');
//        if (e === "load")
//            fillKendoUpload(this);
//    });

//    $("[data-on-load='fillKendoTree(this)']").each(function () {
//        var view = $(this).data('view');
//        if (view === 'specification')
//            fillKendoTreeProduct(this);
//        if (view === 'specificationOption')
//            fillKendoTreeSpecificationOption(this);
//        if (view === 'category')
//            fillKendoTreeCategory(this);

//    });

//    $("[data-on-load='fillKendoUpload(this)']").each(function () {
//        fillKendoUpload(this);
//    });

//    $("[data-on-load='fillKendoEditor(this)']").each(function () {
//        fillKendoEditor(this);
//    });

//    $("[data-on-load='fillKendoGrid(this)']").each(function () {
//        var view = $(this).data('view');
//        if (view === 'Category')
//            fillKendoGridCategory(this);
//        if (view === 'Company')
//            fillKendoGridCompany(this);
//        if (view === 'CategoryReview')
//            fillKendoGridCategoryReview(this);
//        if (view === 'CompanyAttachment')
//            fillKendoGridCompanyAttachment(this);
//        if (view === 'CompanyImage')
//            fillKendoGridCompanyImage(this);
//        if (view === 'CompanyQuestion')
//            fillKendoGridCompanyQuestion(this);
//        if (view === 'CompanyReview')
//            fillKendoGridCompanyReview(this);
//        if (view === 'Product')
//            fillKendoGridProduct(this);
//        if (view === 'Specification')
//            fillKendoGridSpecification(this);
//        if (view === 'SpecificationOption')
//            fillKendoGridSpecificationOption(this);
//        if (view === 'User')
//            fillKendoGridUser(this);
//        if (view === 'UserMeta')
//            fillKendoGridUserMeta(this);
//    });
//}

//function changeEvent(tag) {
//    var id = $(tag).find(':selected').val();
//    var hidden = $('#SpecificationId');
...
//function onSelectKendoTreeProduct(elem) {
...
//function fillKendoTreeProduct(elem) {
//    debugger;
//    $(elem).data("tree-event", "loaded");
//    var action = $(elem).data('tree-product');
//    var field = "#" + $(elem).data('tree-for');
//    var id = $(field).val();
//    $.ajax({
//        url: action,
//        data: {},
...
//                dataSource: toHierarchicalDataSource(dataSource, "id", "parent", null),
//                select: function (e) {
//                    var categoryId = $(elem).getKendoTreeView().dataItem(e.node).id;
//                    $(field).val(categoryId);
//                    onSelectKendoTreeProduct(elem);
//                }
//            });
//            if (id !== "00000000-0000-0000-0000-000000000000")
//                expandAndSelectNode(elem, id);
//        }
//    });
//};

//function fillKendoTreeSpecificationOption(tag) {
//    debugger;
//    var url = $(tag).data('url');
//    var container = $(tag).data('container');
//    var specificationContainer = $(tag).data('specification-container');
//    var specificationUrl = $(tag).data('specification-url');
//    var speccontainerurl = $(tag).data('spec-container-url');
//    var hidden = $(tag).data('hidden');
//    var id = $(hidden).val();
//    $.ajax({
//        url: url,
...
//                dataSource: toHierarchicalDataSource(dataSource, "id", "parent", null),
//                select: function (e) {
//                    var categoryId = $(container).getKendoTreeView().dataItem(e.node).id;
//                    $(hidden).val(categoryId);
//                    $(specificationContainer).find('option').remove().end();
//                    $(specificationContainer).append($("<option></option>").attr("value", "")
//                        .text("یک گزینه انتخاب گردد"));
//                    $('#SpecificationId').val('');
//                    $.ajax({
//                        type: "GET",
...
//                                        .append($("<option></option>").attr("value", result[key].Id)
//                                            .text(result[key].Title));
//                                });
//                            // var ss=$(specificationContainer).attr('selected', 'selected');
//                        }
//                    });
//                }
//            });
