...
{
    public partial class CompanyVideoController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected CompanyVideoController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CompanyVideoController Actions { get { return MVC.CompanyVideo; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "CompanyVideo";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "CompanyVideo";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _AddItem = "~/Views/CompanyVideo/_AddItem.cshtml";
            public readonly string _Item = "~/Views/CompanyVideo/_Item.cshtml";
            public readonly string _List = "~/Views/CompanyVideo/_List.cshtml";
            public readonly string _ListMore = "~/Views/CompanyVideo/_ListMore.cshtml";
            public readonly string Create = "~/Views/CompanyVideo/Create.cshtml";
            public readonly string Detail = "~/Views/CompanyVideo/Detail.cshtml";
            public readonly string Edit = "~/Views/CompanyVideo/Edit.cshtml";
            public readonly string List = "~/Views/CompanyVideo/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CompanyVideoController : Advertise.Web.Controllers.CompanyVideoController
    {
        public T4MVC_CompanyVideoController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.CompanyVideo.CompanyVideoCreateViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Create(Advertise.Core.Models.CompanyVideo.CompanyVideoCreateViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditApproveOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.CompanyVideo.CompanyVideoEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> EditApprove(Advertise.Core.Models.CompanyVideo.CompanyVideoEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.EditApprove);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void EditRejectOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.CompanyVideo.CompanyVideoEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> EditReject(Advertise.Core.Models.CompanyVideo.CompanyVideoEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.EditReject);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.CompanyVideo.CompanyVideoSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> List(Advertise.Core.Models.CompanyVideo.CompanyVideoSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.List);
        ...
        [NonAction]
        partial void MyEditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.CompanyVideo.CompanyVideoEditViewModel viewModel);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> MyEdit(Advertise.Core.Models.CompanyVideo.CompanyVideoEditViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.MyEdit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
        ...
        [NonAction]
        partial void MyListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Advertise.Core.Models.CompanyVideo.CompanyVideoSearchRequest request);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> MyList(Advertise.Core.Models.CompanyVideo.CompanyVideoSearchRequest request)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.MyList);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "request", request);
