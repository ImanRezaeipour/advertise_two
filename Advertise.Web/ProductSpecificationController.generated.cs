...
{
    public partial class ProductSpecificationController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProductSpecificationController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> EditAjax()
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.EditAjax);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductSpecificationController Actions { get { return MVC.ProductSpecification; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductSpecification";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductSpecification";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Create = "~/Views/ProductSpecification/_Create.cshtml";
            public readonly string _Edit = "~/Views/ProductSpecification/_Edit.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductSpecificationController : Advertise.Web.Controllers.ProductSpecificationController
    {
        public T4MVC_ProductSpecificationController() : base(Dummy.Instance) { }

        [NonAction]
        partial void CreateAjaxOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, System.Guid? categoryId);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> CreateAjax(System.Guid? categoryId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.CreateAjax);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "categoryId", categoryId);
            CreateAjaxOverride(callInfo, categoryId);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }
        ...
        [NonAction]
        partial void EditAjaxOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, System.Guid? productId);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> EditAjax(System.Guid? productId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.EditAjax);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "productId", productId);
            EditAjaxOverride(callInfo, productId);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }
