...
namespace Advertise.Web.Controllers
{
    public partial class ProductImageController
    {
        ...
        protected ProductImageController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> GetListAjax()
        {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductImageController Actions { get { return MVC.ProductImage; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductImage";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductImage";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        static readonly ActionParamsClass_GetListAjax s_params_GetListAjax = new ActionParamsClass_GetListAjax();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetListAjax GetListAjaxParams { get { return s_params_GetListAjax; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetListAjax
        {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductImageController : Advertise.Web.Controllers.ProductImageController
    {
        public T4MVC_ProductImageController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GetListAjaxOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, System.Guid? productId);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.JsonResult> GetListAjax(System.Guid? productId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.GetListAjax);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "productId", productId);
            GetListAjaxOverride(callInfo, productId);
            return System.Threading.Tasks.Task.FromResult(callInfo as System.Web.Mvc.JsonResult);
        }
