namespace Advertise.Core.Constants
{
    public static class ContentDeliveryNetwork
    {
        ...
        public static class Microsoft
        {
            ...
            public const string AspNetSignalrScriptUrl = "//ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js";
            public const string JQueryUnobtrusiveAjaxUrl = "//ajax.aspnetcdn.com/ajax/mvc/3.0/jquery.unobtrusive-ajax.min.js";
